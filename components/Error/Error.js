        ...
        <Grid container>
            ...
            <div className={classes.flex}>
              <div className={classes.illustration}>
                <img
                  ...
                  data-2d={imgAPI.socialInner[8]}
                  data-3d={imgAPI.socialInner[9]}
                  className="img-2d3d"
                  alt="error"
                />
              </div>
          ...
          <Grid item md={7} xs={12}>
            <div className={classes.text}>
              ...
              <Button color="primary" variant="contained" href={link.social.home} size="large" className={classes.button}>
                {t('back')}
              </Button>
            </div>
          </Grid>

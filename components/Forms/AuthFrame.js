        ...
        <Grid container spacing={isMobile ? 1 : 2}>
          ...
          <Grid item md={6} xs={12}>
            <div className={classes.greeting}>
              ...
              <h6 className={text.subtitle2}>{subtitle}</h6>
              <div className={classes.img}>
                {type === 'login' ? (
                  <img
                    src={imgAPI.socialInner[3]}
                    data-2d={imgAPI.socialInner[2]}
                    data-3d={imgAPI.socialInner[3]}
                    className="img-2d3d"
                    alt="login"
                  />
                ) : (
                  <img
                    ...
                    data-2d={imgAPI.socialInner[4]}
                    data-3d={imgAPI.socialInner[5]}
                    className="img-2d3d"
                    alt="register"
                  />
                )}
